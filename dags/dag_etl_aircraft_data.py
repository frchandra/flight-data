...
temp_path = '/opt/airflow/data'

default_args = {
    'owner': 'ah',
    'start_date': datetime(2021, 2, 15, 0, 0, 0, 0),
    'end_date': datetime(2023, 1, 1, 0, 0, 0, 0),
    'retries': 1,
...
stage_aircraft_types_task = CSVToPostgresOperator(
    ...
    path_to_csv='/opt/airflow/data/AircraftTypes.csv',
    delimiter=',',
...
stage_aircraft_database_task = CSVToPostgresOperator(
    ...
    path_to_csv='/opt/airflow/data/aircraftDatabase.csv',
    delimiter=',',
    additional_params='CSV HEADER'
)
...
stage_airports_task = CSVToPostgresOperator(
    ...
    path_to_csv='/opt/airflow/data/airports.csv',
    delimiter=',',
    additional_params='CSV HEADER'
)
