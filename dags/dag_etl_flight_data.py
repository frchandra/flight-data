...
default_args = {
    ...
    'start_date': datetime(2022, 11, 26, 13, 10, 38, 0),
    'end_date': datetime(2023, 2, 10, 3, 0, 0, 0),
    'retries': 1,
...
stage_flights_task = APItoPostgresOperator(
    ...
    api_path='https://opensky-network.org/api/flights/all?begin=1669341600&end=1669348800',
